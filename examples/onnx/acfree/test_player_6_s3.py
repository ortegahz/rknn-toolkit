...
from test_player_6_s1 import QUANTIZE_ON
from test_player_6_s2 import IMG_PATH
...
if __name__ == '__main__':
    ...
    if os.path.exists(fn_txt):
        os.remove(fn_txt)
    for box, score, cl in zip(reversed(boxes), reversed(scores), reversed(classes)):
